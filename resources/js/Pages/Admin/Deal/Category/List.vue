...
const search = useDebounceFn(() => {
  router.get(route("admin.categories-deals.list"), filters.value, {
    preserveState: true,
    replace: true,
    onSuccess: () => {
...
const destroyCategory = (id: number) => {
  router.delete(route("admin.categories-deals.destroy", id), {
    preserveState: true,
    replace: true,
    onSuccess: () => {
      categories.value = props.categories
...
<template>
  ...
  <div class="flex flex-wrap justify-between gap-4">
    ...
    <Link :href="route('admin.categories-deals.create')">
    ...
    <TableBody>
      ...
      <TableRow v-for="category in categories" :key="category.id">
        ...
        <TableCell class="flex justify-end gap-4">
          <Link :href="route('admin.categories-deals.edit', category.id)">
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  définitivement votre catégorie ainsi que tous les deals et les
